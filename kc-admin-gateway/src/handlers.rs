...
mod tests {
    ...
    fn gateway_config_for_break_glass() -> GatewayConfig {
        GatewayConfig {
            ...
            admin_base_url: "https://keycloak.test".to_string(),
            admin_host_header: None,
            admin_forwarded_proto: None,
            introspection_url: "https://keycloak.test/introspect".to_string(),
            ...
            expected_issuer: Some("https://issuer.test".to_string()),
            ...
            exchange_url: "https://keycloak.test/token".to_string(),
