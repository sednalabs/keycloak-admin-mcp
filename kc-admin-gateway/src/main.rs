...
mod tests {
    ...
    fn base_gateway_config() -> GatewayConfig {
        GatewayConfig {
            ...
            expected_issuer: Some("http://127.0.0.1:8080/realms/example-realm".to_string()),
            ...
            exchange_url: "http://127.0.0.1:8080/realms/example-realm/protocol/openid-connect/token".to_string(),
