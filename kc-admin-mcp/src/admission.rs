...
//!
//! ## Rationale
//! Restarts should be deterministic and linked to explicit gate evidence for the
...
mod tests {
    ...
    fn base_config(mode: StartupAdmissionMode) -> StartupAdmissionConfig {
        StartupAdmissionConfig {
            ...
            fast_gate_artifact_path: temp_path("kc-admin-fast-gate").join("fast.json"),
            standard_gate_artifact_path: temp_path("kc-admin-standard-gate").join("standard.json"),
            bypass: false,
            bypass_reason: None,
            bypass_ttl_s: None,
